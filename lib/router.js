...
Router.map(function() {
	...
	this.route('doc_search_template_list', 	{path: '/doc_search_template_list.html'});
	this.route('doc_selected_template', 	{path: '/doc_selected_template.html'});
	...
	this.route('patient_settings', 
	{
		path: '/patient_settings.html',
		waitOn: function() {
			return [
				Meteor.subscribe('patients'),
			];
